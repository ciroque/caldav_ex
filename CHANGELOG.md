...
- Test coverage for `color` field: PROPFIND body includes `calendar-color`,
  XML parsing of Apple `<AAPL:calendar-color>` property, `nil` when absent,
  and end-to-end mapping to `%CalDAVEx.Types.Calendar{color: ...}`.
...
[0.2.2]: https://github.com/ciroque/caldav_ex/releases/tag/v0.2.2
